...
---  
```
Открыть командную строку, далее -
перейти в дирректорию проекта: cd .../currency-gif-giver-test-application
запустить сборку Gradle: gradle bootRun
```  
Использование:
---  
```
Открыть браузер, в строке поиска -
localhost:9000
```  
